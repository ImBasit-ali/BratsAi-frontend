    ...
    <div className="relative w-full h-full min-h-[400px] bg-[#0D1726] rounded-2xl overflow-hidden border border-white/10">
      ...
      {showEmptyState && (
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <p className="text-sm font-medium text-white/40">No MRI loaded</p>
          <p className="text-xs mt-1 text-white/25">Upload files and run segmentation to view results</p>
        </div>
      )}
    </div>
  );
